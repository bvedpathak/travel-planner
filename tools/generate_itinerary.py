...
CITY_DATA = {
    "Austin": {
        "attractions": [
            ...
            {
                "name": "6th Street Entertainment District",
                "type": "nightlife",
                "duration": "Evening",
                "cost": "Varies",
            },
        ...
        "activities": [
            ...
            {
                "name": "Live music at The Continental Club",
                "type": "nightlife",
                "duration": "Evening",
                "cost": "$10-20",
            },
            {
                "name": "Hiking at Mount Bonnell",
                "type": "nature",
                "duration": "1-2 hours",
                "cost": "Free",
            },
            {
                "name": "Shopping at The Domain",
                "type": "shopping",
                "duration": "Half day",
                "cost": "Varies",
            },
        ...
        "restaurants": [
            {
                ...
                "cuisine": "Dessert",
                "price": "$$",
                "note": "Famous chocolate and ice cream",
            },
            {
            ...
            },
            {
                ...
                "cuisine": "Mexican",
                "price": "$",
                "note": "Authentic Mission burritos",
            },
        ],
        "activities": [
            {
            ...
            {
                "name": "Bike ride across Golden Gate Bridge",
                "type": "nature",
                "duration": "Half day",
                "cost": "$40-60",
            },
    ...
    "New York": {
        ...
        "restaurants": [
            {
                ...
                "cuisine": "Deli",
                "price": "$$",
                "note": "Famous pastrami sandwiches",
            },
            {
                ...
                "cuisine": "Steakhouse",
                "price": "$$$$",
                "note": "Historic Brooklyn steakhouse",
            },
            {
                "name": "Di Fara Pizza",
                "type": "food",
            ...
            },
            {
                ...
                "cuisine": "Jewish",
                "price": "$$",
                "note": "Traditional appetizing shop",
            },
            {
                "name": "Joe's Pizza",
                "type": "food",
        ...
        "activities": [
            ...
            {
                "name": "Jazz at Blue Note",
                "type": "nightlife",
                "duration": "Evening",
                "cost": "$30-50",
            },
            {
                "name": "Ferry to Staten Island",
                "type": "nature",
                "duration": "2-3 hours",
                "cost": "Free",
            },
            {
                "name": "Rooftop bars in Manhattan",
                "type": "nightlife",
                "duration": "Evening",
                "cost": "$15-25/drink",
            },
    ...
    "Miami": {
        ...
        "activities": [
            ...
            {
                "name": "Boat tour of Biscayne Bay",
                "type": "nature",
                "duration": "2-3 hours",
                "cost": "$40-60",
            },
            {
                "name": "Salsa dancing in Little Havana",
                "type": "nightlife",
                "duration": "Evening",
                "cost": "$20-30",
            },
            {
                "name": "Shopping at Lincoln Road",
                "type": "shopping",
                "duration": "Half day",
                "cost": "Varies",
            },
...
async def generate_itinerary(
    city: str, days: int, interests: Optional[List[str]] = None
) -> Dict[str, Any]:
    """
    ...
    for day in range(1, days + 1):
        ...
        # Add breakfast
        breakfast_spot = random.choice(
            [
                r
                for r in filtered_restaurants
                if r.get("cuisine") in ["Breakfast", "Bakery", "American"]
            ]
        )
        ...
        if "nightlife" in interests:
            nightlife_options = [
                item
                for item in city_data["attractions"] + city_data["activities"]
                if item["type"] == "nightlife"
            ]
        ...
        day_schedule = {
            ...
            "dailyBudget": _estimate_daily_budget(
...
def _suggest_transportation(city: str) -> Dict[str, str]:
    ...
    transport_options = {
        "Austin": {
            "primary": "Car/Rideshare",
            "alternative": "Capital Metro Bus",
            "note": "Car recommended for attractions outside downtown",
        },
        "San Francisco": {
            "primary": "Public Transit",
            "alternative": "Walking + Muni",
            "note": "Excellent public transportation system",
        },
        "New York": {
            "primary": "Subway",
            "alternative": "Walking + Taxi",
            "note": "Subway is fastest for long distances",
        },
        "Miami": {
            "primary": "Car/Rideshare",
            "alternative": "Metrobus",
            "note": "Car recommended for beach areas",
        },
    }
    ...
    return transport_options.get(
        city,
        {
            "primary": "Walking/Rideshare",
            "alternative": "Public Transit",
            "note": "Check local transportation options",
        },
    )
...
def _get_local_tips(city: str) -> List[str]:
    ...
    local_tips = {
        "Austin": [
            "Food trucks are a local institution",
            "Music is everywhere - embrace it",
            "Traffic can be heavy during rush hour",
        ],
        "San Francisco": [
            "Steep hills everywhere - wear good shoes",
            "Foggy afternoons are common",
            "Neighborhoods have distinct personalities",
        ],
        "New York": [
            "Walk fast and stay right",
            "Street food is safe and delicious",
            "Each borough has its own character",
        ],
        "Miami": [
            "Spanish is widely spoken",
            "Beach culture is relaxed",
            "Art scene is world-class",
        ],
    }

    return local_tips.get(
        city,
        ["Ask locals for recommendations", "Try local specialties", "Be open to new experiences"],
    )
